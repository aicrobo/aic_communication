...
void requestSimulation(std::shared_ptr<AicCommuInterface> obj){
    ...
    while(1){
        ...
        json req;
        req["header"]["type"] = 1;
        req["body"]["msg"]    = "test req msg";
        req["body"]["order"]  = order++;
        std::string pack = req.dump();
...
int main()
{
    ...
    auto obj = AicCommuFactory::newSocket(AicCommuType::CLIENT_REQUEST, "127.0.0.1", 60005, "req");//create communication object, essential
